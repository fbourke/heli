...
SCREEN_SIZE = (1400, 800) #resolution of the game
...
background = pygame.image.load("world/background.jpg").convert_alpha()
...
while True:
    ...
    for event in pygame.event.get():
        ...
        #     print aim
        # if firing:
        #     Shot(crashman.rect[0],aim)
            mposx,mposy = event.pos
            gx = crashman.rect[0]+25
            gy = crashman.rect[1]+30
            print('Gun X: %s' %gx)
            print('Gun Y: %s' %gy)
            print(mposx,mposy)
